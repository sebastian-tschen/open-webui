...
class ERROR_MESSAGES(str, Enum):
    ...
    API_KEY_FORMAT_ERROR = "The API key needs to be 'sk-' + a 32-character hexadecimal string (0-9,a-f). e.g. 'sk-123456789012345678901234567890af' Please ensure that the API key is in the correct format and try again."
